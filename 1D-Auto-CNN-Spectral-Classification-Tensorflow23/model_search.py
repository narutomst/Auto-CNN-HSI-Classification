...
import numpy as np
# import global_variable_config
import global_variable as glv
# global num_bands


# model_search包含3个类：MixedOp, Cell, Network,都是继承自nn.Module,以下是3个类的定义：
...
class Network(nn.Module):
    ...
    def __init__(self, C, num_classes, layers, criterion, steps=4, multiplier=4, stem_multiplier=3):
        super(Network, self).__init__()  # model.py: line 223
        self._C = C
        ...
        for i in range(layers):
            if i in [layers // 3]:
                ...
                reduction = False
            cell = Cell(steps, multiplier, C_prev_prev, C_prev, C_curr, reduction, reduction_prev)  # model_search.py: line 27
